...
function esModulesFix() {
  return {
    name: 'es-modules-fix',
    config() {
      console.log('🔧 ES Modules Fix Plugin ativo - REACT GLOBAL SIMPLES');
    }
  };
}
...
export default defineConfig({
  ...
  build: {
    ...
    rollupOptions: {
      output: {
        manualChunks: undefined, // Deixar Vite decidir novamente
    ...
    terserOptions: {
      ...
      mangle: {
        ...
        // Preservar React e funções relacionadas
