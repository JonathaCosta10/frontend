...
export default function GoogleAuthButtonFixed({ context = "signin" }: Props) {
  ...
  const handleGoogleAuth = async () => {
    ...
    try {
      ...
      // Server-driven: usar endpoint unificado do backend com paridade de parâmetros
      ...
      const authUrl = `${backendUrl}/auth/unified/google/signin/?${signinParams.toString()}`;
      
      console.log("🔗 URL de autenticação (server-driven):", authUrl);
