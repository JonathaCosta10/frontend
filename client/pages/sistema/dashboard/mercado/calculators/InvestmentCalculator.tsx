...
export default function InvestmentCalculator() {
  ...
  // Usando formatCurrency do contexto de tradução ao invés de implementar localmente
            ...
            {calculationType === "contribution" ? (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="goal">{t("investment_goal")}</Label>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="monthlyAmount">{t("monthly_contribution")}</Label>
                  <Input
                    id="monthlyAmount"
                    type="number"
