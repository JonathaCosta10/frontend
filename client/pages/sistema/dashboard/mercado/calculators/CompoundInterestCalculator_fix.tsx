...
import { CompoundInterestInput, CompoundInterestResult } from "@/src/entities/FinancialCalculator";
              ...
              <div className="space-y-2">
                ...
                <Select 
                  ...
                  onValueChange={(value) => 
                    setCompound({
                      ...compound,
                      frequency: value as "monthly" | "yearly" | "quarterly"
                    })
                  }
                >
                  <SelectTrigger>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg border-l-4 border-purple-500">
                  ...
                  <p className="text-xs text-purple-600/80">
                    {t("yield")}: {formatNumber(compoundResult.percentageGain)}
                    % {t("of_investment")}
                  </p>
                </div>
              </div>
