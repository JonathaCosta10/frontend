...
export default function FIIAnaliseDetalhada() {
  ...
  const {
    ...
    queryFn: () => {
      console.log('Chamando API de FII para ticker:', ticker);
      console.log('URL da API será:', `http://127.0.0.1:5000/api/investimentos/analise-ativo/fii/?ticker=${ticker}`);
      return analisarAtivoFII(ticker!);
    },
      ...
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-blue-600 mt-1">API: http://127.0.0.1:5000/api/investimentos/analise-ativo/fii/?ticker={ticker}</p>
          </div>
        </div>
