...
const COMPONENT_IMPORTS: Record<string, () => Promise<any>> = {
  '/sistema/dashboard/orcamento': () => import('@/features/budget/pages/orcamento/index'),
  '/sistema/dashboard/orcamento/entradas': () => import('@/features/budget/pages/orcamento/entradas'),
  '/sistema/dashboard/orcamento/custos': () => import('@/features/budget/pages/orcamento/custos'),
  '/sistema/dashboard/orcamento/dividas': () => import('@/features/budget/pages/orcamento/dividas'),
  '/sistema/dashboard/orcamento/metas': () => import('@/features/budget/pages/orcamento/metas'),
  
  '/sistema/dashboard/investimentos': () => import('@/features/investments/pages/investimentos/index'),
  '/sistema/dashboard/investimentos/comparativos': () => import('@/features/investments/pages/investimentos/comparativos'),
  '/sistema/dashboard/investimentos/cadastro': () => import('@/features/investments/pages/investimentos/cadastro'),
  '/sistema/dashboard/investimentos/ranking': () => import('@/features/investments/pages/investimentos/ranking'),
  '/sistema/dashboard/investimentos/patrimonio': () => import('@/features/investments/pages/investimentos/patrimonio'),
  
  '/sistema/dashboard/mercado': () => import('@/features/market/pages/mercado/index'),
  '/sistema/dashboard/mercado/indicadores-economicos': () => import('@/features/market/pages/mercado/indicadores-economicos'),
  '/sistema/dashboard/mercado/lista-de-desejo': () => import('@/features/market/pages/mercado/lista-de-desejo'),
  '/sistema/dashboard/mercado/analise-ticker': () => import('@/features/market/pages/mercado/analise-ticker'),
  '/sistema/dashboard/mercado/calculadora-financeira': () => import('@/features/market/pages/mercado/calculadora-financeira'),
  
  '/sistema/dashboard/cripto': () => import('@/features/crypto/pages/cripto/index'),
  '/sistema/dashboard/cripto/mercado': () => import('@/features/crypto/pages/cripto/mercado'),
  '/sistema/dashboard/cripto/portfolio': () => import('@/features/crypto/pages/cripto/portfolio'),
  '/sistema/dashboard/cripto/cadastro': () => import('@/features/crypto/pages/cripto/cadastro'),
  
  '/sistema/dashboard/treinamentos': () => import('@/features/dashboard/pages/treinamentos/Training'),
  '/sistema/dashboard/treinamentos/fundos-investimentos': () => import('@/features/dashboard/pages/treinamentos/fundos-investimentos'),
  '/sistema/dashboard/treinamentos/renda-fixa': () => import('@/features/dashboard/pages/treinamentos/renda-fixa'),
  '/sistema/dashboard/treinamentos/acoes': () => import('@/features/dashboard/pages/treinamentos/acoes'),
  '/sistema/dashboard/treinamentos/macroeconomia': () => import('@/features/dashboard/pages/treinamentos/macroeconomia'),
  
  '/sistema/dashboard/info-diaria': () => import('@/features/dashboard/pages/info-diaria'),
  '/sistema/dashboard/perfil': () => import('@/features/dashboard/pages/perfil'),
  '/sistema/dashboard/configuracoes': () => import('@/features/dashboard/pages/configuracoes'),
  '/sistema/dashboard/suporte': () => import('@/features/dashboard/pages/suporte'),
};
